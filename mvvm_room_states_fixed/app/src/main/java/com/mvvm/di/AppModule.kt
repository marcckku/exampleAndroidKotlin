...
object AppModule {
    ...
    @Provides
    @ViewModelScoped
    fun provideApplication(@ApplicationContext app: Context): ApplicationGlobal {
        return app as ApplicationGlobal
    }
    ...
    fun provideApiFilmService(): ApiFilmService{
        ...
        val okClient: OkHttpClient = OkHttpClient.Builder()
            ...
            .build()
        return Retrofit.Builder().baseUrl(ApplicationGlobal.DEFAULT_SERVER_DOMAIN_URL)
    ...
    fun provideApiFilmServiceLazy(): Lazy<ApiFilmService>{
        val client : Lazy<ApiFilmService> = ApplicationGlobal.initRetrofitLazy
        return client
    }
    ...
    @ViewModelScoped
    @Provides
    fun provideDatabase(@ApplicationContext applicationContext : Context): DbManager {
        return DbManager(context = applicationContext)
    }

//    @ViewModelScoped
//    @Provides
//    fun provideState() : ApiFilmServiceImpl {
//        val stateView: SavedStateHandle  by viewModels()
